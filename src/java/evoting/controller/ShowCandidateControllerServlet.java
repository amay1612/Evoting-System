...
public class ShowCandidateControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       String data=request.getParameter("data");
        System.out.println("in show candidate controller "+data);
       try
       {
       if(data!=null && data.equalsIgnoreCase("cid"))
       {
           ...
           System.out.println("=================================== ");
           System.out.println("In show candidate and in if condition :"+candidateList);
       ...
       else
       {
           ...
           System.out.println("In show servlet and else cond");
