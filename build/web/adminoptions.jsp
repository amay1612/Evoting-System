    ...
    <body>
        <%
            ...
            StringBuffer displayBlock = new StringBuffer(
                    "<div class='sticky'><div class='candidate'>VOTE FOR CHANGE</div><br>" + "<div class='subcandidate'>Admin Actions Page</div>"
                    + "<br><br>" + "<div class='logout'>"
                    + "<a href='login.html'>logout</a></div></div>");
            ...
            displayBlock.append("<br><br><div ='center' id='result'></div>");
